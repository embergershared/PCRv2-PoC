...
Connect-AzAccount
Get-AzSubscription
Set-AzContext -Subscription "XXXX-YYYY-ZZZ"

# Get the Application Gateway we want to modify
$appgw = Get-AzApplicationGateway -Name "appgw-use2-s4-pcr2-poc" -ResourceGroupName "rg-use2-s4-pcr2-poc"

# Specify the resource id to the user assigned managed identity - This can be found by going to the properties of the managed identity
Set-AzApplicationGatewayIdentity -ApplicationGateway $appgw -UserAssignedIdentityId "XXX-YYY-ZZZ"

# Get the secret ID from Key Vault
$secret = Get-AzKeyVaultSecret -VaultName "kv-use2-s4-pcr2-poc" -Name "pcr2-poc"
