...
//            // Debug
//            Output.Log(log, $"Launched from {Environment.CurrentDirectory}");
//            Output.Log(log, $"Physical location {AppDomain.CurrentDomain.BaseDirectory}");
//            Output.Log(log, $"AppContext.BaseDir {AppContext.BaseDirectory}");
//            Output.Log(log, $"Runtime Call {Path.GetDirectoryName(Process.GetCurrentProcess().MainModule.FileName)}");
...
//                {
//                    ExecutablePath = ".\\WinSCP\\WinSCP.exe"
//                };
